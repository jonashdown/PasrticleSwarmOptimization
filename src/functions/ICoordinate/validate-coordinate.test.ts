...
describe('validateCoordinate ()', () => {
  it.each([
    ...
    const result = validateCoordinate(input)
  ...
  it.each([
    ...
    expect(() => validateCoordinate(input)).toThrowError(TypeError)
    expect(() => validateCoordinate(input)).toThrow(
      'coordinate must be a numerical array'
    )
  })
})
